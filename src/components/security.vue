    ...
    <div class="table">
      <div class="cell">
        ...
        <div id="anleitung">
          <br>
          <h1>
            <strong>Please Set a 4 Digit PIN-Code.</strong><br>
          </h1>
        </div>
...
export default {
  ...
  watch: {
    screen: function() {
    if(this.screen.length === 4) {
        this.$store.state.ispasscode = true
        this.$store.dispatch('passcodesave' , this.screen)
...
#pincode {
  ...
  background-image: url("../pages/mountain.jpg");
